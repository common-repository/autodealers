<?php
/**
 * Plugin Name: Autodealers
 * Plugin URI: https://www.autodealers.nl
 * Description: Via Autodealers heeft u de ideale service in handen om snel en makkelijk uw occasionbedrijf in te richten. Deze plugin biedt u de mogelijkheid uw occasions binnen Wordpress weer te geven. Kijk voor meer informatie op <a href="https://www.autodealers.nl" target="_blank">www.autodealers.nl</a>.
 * Version: 1.0.2
 * Tested up to: 4.7 
 * Author: Frank Bonnet
 * Author URI: https://autodealers.nl/
*/
...
if ( ! class_exists( 'Autodealers' ) ) {
	...
	class Autodealers {
		...
		protected $tag = 'autodealers-plugin';
		...
		protected $settings = array(
			...
			'did' => array(
				...
				'description' => 'Uw Autodealers klantnummer (neem contact op met Autodealers als u deze niet weet)',
            ...
            'querystring' => array(
				...
				'description' => '(Optioneel) Door Autodealers aangeleverde code',
		...
		public function __construct(){
			...
			add_shortcode(
                ...
                $this->stock_shortcode,

                array(&$this, 'stock_shortcode'));



            add_shortcode(

                $this->search_block_shortcode,

                array(&$this, 'search_block_shortcode'));



            add_shortcode(

                $this->insurance_shortcode,

                array(&$this, 'insurance_shortcode'));

	add_shortcode(
		
		$this->carousel_shortcode, 
		...
		public function register_settings() {
			...
			add_settings_section(
				...
				$this->name . ' Plugin v0.2',

				function () {

					echo '<h2>Uw occasionlijst binnen uw Wordpress website</h2>'.
                         '<div style="background:#fff;padding:10px 20px;border:dotted 2px #ccc;"><p>Via Autodealers heeft u de ideale service in handen om snel en makkelijk uw occasionbedrijf in te richten.'.
                         '<li>Kijk voor meer informatie op <a href="//www.autodealers.nl" target="_blank">www.autodealers.nl</a> of <a href="//www.autodealers.nl/adverteren.aspx" target="_blank">meld u aan via deze link</a>.</li>'.
                         '<li>Stel uw vraag via <a href="mailto:service@autodealers.nl?Subject=Autodealers Wordpress Plugin vraag">service@autodealers.nl</a> of via onze helpdesk: <b>020 - 4714915</b></li>'.
                         '<br /><hr />'.
...
function register_files() {
    wp_register_script( 'custom_jquery', plugins_url('/autodealers/custom-jquery.js') );
    wp_register_style( 'custom_style', plugins_url('/autodealers/style.css') );
}
...
function your_plugin_settings_link($links) {
    $settings_link = '<a href="options-general.php?page=autodealers-plugin">Instellingen</a>';
